## Final Code for all firing rate plots and best-fit plots

setwd("C:/Users/stephanie/Desktop/2019/Spring/STA141A/Project") 
library(R.matlab)
ephysroot = 'C:/Users/stephanie/Desktop/2019/Spring/STA141A/Project/'; # path of the data set 
...
plot(x = time_frame, y = firing_rate_vec, main = "Firing rates for faceSVD", xlab = "Time", ylab = 
       "Frequency (HZ)", type="l", ann=T, cex.lab=0.8, lwd=1) 
...
plot(x = time_frame, y = firing_rate_vec1, main = "Firing rates for CP", xlab = "Time", ylab = 
       "Frequency (HZ)", type="l", ann=T, cex.lab=0.8, lwd=1) 
...
plot(x = time_frame, y = firing_rate_vec2,main = "Firing rates for FrMoCtx", xlab = "Time", ylab = 
       "Frequency (HZ)", type="l", ann=T, cex.lab=0.8, lwd=1) 
...
plot(x = time_frame, y = firing_rate_vec3, main = "Firing rates for HPF",xlab = "Time", ylab = 
       "Frequency (HZ)", type="l", ann=T, cex.lab=0.8, lwd=1) 
...
plot(x = time_frame, y = firing_rate_vec4, main = "Firing rates for LS",xlab = "Time", ylab = 
       "Frequency (HZ)", type="l", ann=T, cex.lab=0.8, lwd=1) 
...
plot(x = time_frame, y = firing_rate_vec5, main = "Firing rates for MB",xlab = "Time", ylab = 
       "Frequency (HZ)", type="l", ann=T, cex.lab=0.8, lwd=1) 
...
plot(x = time_frame, y = firing_rate_vec6, main = "Firing rates for SC",xlab = "Time", ylab = 
       "Frequency (HZ)", type="l", ann=T, cex.lab=0.8, lwd=1) 
...
plot(x = time_frame, y = firing_rate_vec7, main = "Firing rates for soMoCtx",xlab = "Time", ylab = 
       "Frequency (HZ)", type="l", ann=T, cex.lab=0.8, lwd=1) 
...
plot(x = time_frame, y = firing_rate_vec8, main = "Firing rates for TH",xlab = "Time", ylab = 
       "Frequency (HZ)", type="l", ann=T, cex.lab=0.8, lwd=1) 
...
plot(x = time_frame, y = firing_rate_vec9, main = "Firing rates for V1",xlab = "Time", ylab = 
       "Frequency (HZ)", type="l", ann=T, cex.lab=0.8, lwd=1) 



## Overlaid ggplots by groups ########################################################################
## Run code from here to the end to see all four plots ##
